...
if (type === "فندق") {
  if (num > mymy.value()) {
    Bot.sendMessage("ما عندك هل عدد كلة ! ", options)
    return
  }
  var add = num * 130000
  mymy.remove(num)
